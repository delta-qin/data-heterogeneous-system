...
/**
 * @author deltaqin
 * @date 2020/9/14 9:41 上午
 */
@Slf4j
public class SysGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public SysGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
